...
const AdmissionForm = () => {
  ...
  const submitUser = async () => {
    try {
      const docRef = await addDoc(collection(db, "admission"), admission);
      console.log("Document: ", docRef);
      console.log("Document written with ID: ", docRef.id);
      navigate("/dashboard/admissionList");
    } catch (e) {
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <TextField
              ...
              type="text"
              onChange={(e) => {
                setAdmission({ ...admission, userName: e.target.value });
              }}
            />
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <TextField
              ...
              type="email"
              onChange={(e) => {
                setAdmission({ ...admission, email: e.target.value });
              }}
            />
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <TextField
              ...
              type="tel"
              onChange={(e) => {
                setAdmission({ ...admission, phone: e.target.value });
              }}
            />
          </Grid>
          ...
          <Grid item xs={12}>
            ...
            <TextField
              fullWidth
              onChange={(e) => {
                setAdmission({ ...admission, address: e.target.value });
              }}
            />
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <TextField
              ...
              onChange={(e) => {
                ...
                setAdmission({ ...admission, dob: e.target.value });
              }}
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Select
              ...
              onChange={(e) => {
                ...
                setAdmission({ ...admission, course: e.target.value }); // Update object
              }}
            >
              {courses.map((course) => (
          ...
          <Grid item xs={12} sm={6}>
            ...
            <RadioGroup
              ...
              name="gender"
              onChange={(e) => {
                setAdmission({ ...admission, gender: e.target.value });
              }}
            >
              <FormControlLabel
                value="female"
